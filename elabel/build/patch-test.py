...
# logdir =  ["VEQ", "RM", "our",   "best",  "CFL",  "QSI", "CECI"]  # -logdir 参数选项
...
#     query_files = [line.strip() for line in file if line.strip()]
...
#             logdir_param,  # 日志保存到对应的 logdir 目录
#             f"{logdir}_{query_name}.txt"
#         )
